 ...
 // This is part of the TFTDriver class and is associated with anti-aliased font functions
...
*************************************************************************************x*/
void TFTDriver::loadFont(String fontName)
{
  /*
...
void TFTDriver::loadMetrics(uint16_t gCount)
{
...
*************************************************************************************x*/
void TFTDriver::unloadFont( void )
{
  if (gUnicode)
  {
    free(gUnicode);
...
*************************************************************************************x*/
#define DECODE_UTF8
uint16_t TFTDriver::decodeUTF8(uint8_t *buf, uint16_t *index, uint16_t remaining)
{
  byte c = buf[(*index)++];
...
*************************************************************************************x*/
uint16_t TFTDriver::decodeUTF8(uint8_t c)
{
...
*************************************************************************************x*/
uint16_t TFTDriver::alphaBlend(uint8_t alpha, uint16_t fgc, uint16_t bgc)
{
...
*************************************************************************************x*/
uint32_t TFTDriver::readInt32(void)
{
  uint32_t val = 0;
...
*************************************************************************************x*/
bool TFTDriver::getUnicodeIndex(uint16_t unicode, uint16_t *index)
{
...
void TFTDriver::drawGlyph(uint16_t code)
{
  if (code < 0x21)
  {
    if (code == 0x20) {
...
*************************************************************************************x*/
void TFTDriver::showFont(uint32_t td)
{
