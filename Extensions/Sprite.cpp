...
// from the TFTDriver class. Some functions are overridden by this class so that the
...
*************************************************************************************x*/
TFT_eSprite::TFT_eSprite(TFTDriver *tft)
{
...
*************************************************************************************x*/
// Not needed - using TFTDriver class function and this->cursor_x/y
