...
***************************************************************************************/
uint8_t TFTDriver::getTouchRaw(uint16_t *x, uint16_t *y){
  uint16_t tmp;
  CS_H;
...
***************************************************************************************/
uint16_t TFTDriver::getTouchRawZ(void){
  CS_H;
...
uint8_t TFTDriver::validTouch(uint16_t *x, uint16_t *y, uint16_t threshold){
...
uint8_t TFTDriver::getTouch(uint16_t *x, uint16_t *y, uint16_t threshold){
...
***************************************************************************************/
void TFTDriver::calibrateTouch(uint16_t *parameters, uint32_t color_fg, uint32_t color_bg, uint8_t size){
...
***************************************************************************************/
void TFTDriver::setTouch(uint16_t *parameters){
